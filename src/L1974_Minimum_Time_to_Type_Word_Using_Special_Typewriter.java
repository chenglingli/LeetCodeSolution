public class L1974_Minimum_Time_to_Type_Word_Using_Special_Typewriter {
    ...
    public int minTimeToType(String word) {
        ...
        // 针对每个字母，计算下一个字母和当前字母的距离，顺时针距离和逆时针距离，min(字母2-字母1, 26-字母1+字母2)
        int ans = 0;
        int l = word.length();
        char cur = 'a';
    ...
    public static void main(String[] args) {
        ...
        L1974_Minimum_Time_to_Type_Word_Using_Special_Typewriter s = new L1974_Minimum_Time_to_Type_Word_Using_Special_Typewriter();
        long sysDate1 = System.currentTimeMillis();

        String word = "zjpc";
        int res = s.minTimeToType(word);
