...
public class L3852_Smallest_Pair_With_Different_Frequencies {
    ...
    public static void main(String[] args) {
        ...
        L3852_Smallest_Pair_With_Different_Frequencies s = new L3852_Smallest_Pair_With_Different_Frequencies();
        long sysDate1 = System.currentTimeMillis();

        int[] nums = {1, 1, 2, 2, 3, 4};

        int[] res = s.minDistinctFreqPair(nums);
