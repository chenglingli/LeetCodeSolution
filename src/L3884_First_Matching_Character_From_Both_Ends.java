public class L3884_First_Matching_Character_From_Both_Ends {
    ...
    public int firstMatchingIndex(String s) {
        ...
        for (int i = 0; i < len / 2 + 1; i++) {
            if (s.charAt(i) == s.charAt(len - i - 1)) return i;
        }
    ...
    public static void main(String[] args) {
        ...
        L3884_First_Matching_Character_From_Both_Ends s = new L3884_First_Matching_Character_From_Both_Ends();
        long sysDate1 = System.currentTimeMillis();

        String ss = "abc";

        int res = s.firstMatchingIndex(ss);
