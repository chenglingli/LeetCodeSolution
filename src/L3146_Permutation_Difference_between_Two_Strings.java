public class L3146_Permutation_Difference_between_Two_Strings {
    ...
    public static void main(String[] args) {
        ...
        L3146_Permutation_Difference_between_Two_Strings s = new L3146_Permutation_Difference_between_Two_Strings();
        long sysDate1 = System.currentTimeMillis();

        String s1 = "abc";
        String s2 = "bac";

        int res = s.findPermutationDifference(s1, s2);
